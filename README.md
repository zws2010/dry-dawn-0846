...
3. Create a [D1 database](https://developers.cloudflare.com/d1/get-started/) with the name "ancient-darkness-cb43-d1":

```bash
npx wrangler d1 create ancient-darkness-cb43-d1
```
